...
export default function SaraClient({ patients, doctorId }: { patients: Patient[]; doctorId: string }) {
      ...
      <div className="flex-1 overflow-y-auto space-y-3 mb-4">
        {messages.length === 0 && (
          <div className="text-center py-12 text-gray-400">
            ...
            <p className="text-xs mt-1">Puedes preguntar sobre medicamentos, diagnósticos, o el historial de un paciente.</p>
          </div>
        )}
