...
export default function AppointmentsClient({ appointments: initial, patients, doctorId }: Props) {
  ...
  async function handleSave() {
    ...
    const { error, data } = await supabase
      .from('appointments')
      .insert({ patient_id: patientId, doctor_id: doctorId, datetime, reason: reason || null })
