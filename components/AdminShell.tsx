  ...
  return (
    <div className="flex h-screen bg-cream overflow-hidden">
      <div
        ...
        `}
      >
        <AdminNav adminName={adminName} onNavigate={() => setOpen(false)} />
      </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        <header className="md:hidden flex items-center justify-between px-4 py-3 border-b border-border bg-cream-raised shrink-0">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] bg-amber text-graphite px-1.5 py-0.5 rounded font-medium font-mono uppercase tracking-widest">admin</span>
          </div>
          <div className="w-9" />
        </header>
